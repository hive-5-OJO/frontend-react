import type { Customer, CustomerFeature } from '@/entities/customer/model/types';
...
const CustomerDetailHeader = ({ customer, featureData, onClose }: Props) => {
  const alertLevel = featureData ? getAlertLevel(featureData.consultation.last7dConsultCount) : 'low';
